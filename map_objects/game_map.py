...
class GameMap:
    ...
    def make_map(self, max_rooms, room_min_size, room_max_size, map_width, map_height, player, entities):
        ...
        for r in range(max_rooms):
            ...
            for other_room in rooms:
                ...
                # this means there are no intersetions, so this room is valid
    ...
    def create_room(self, room):
        # go throught the tiles in the rectangle and make them passable
        ...
        for i in range(number_of_items):
            ...
            if not any([entity for entity in entities if entity.x == x and entity.y == y]):
                ...
                if item_choice == 'healing_potion':
                    ...
                    equipable_component = Equippable(EquipmentSlots.OFF_HAND, defense_bonus=1)
                    ...
                    item_component = Item(use_function=cast_confuse, targeting=True, targeting_message=Message(
                        'Left-click a enemy to confuse it, or right-click to cancel.', libtcod.light_cyan))
                ...
                #ᵍᵘʸˢ, ʸᵒᵘ ᵍᵒᵗᵗᵃ ᵇᵉ ᵠᵘᶦᵉᵗ    ˢʰʰʰʰʰʰ

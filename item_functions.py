...
def cast_lightning(*args, **kwargs):
    ...
    for entity in entities:
        if entity.fighter and entity != caster and libtcod.map_is_in_fov(fov_map, entity.x, entity.y):
            ...
            #print(str(distance) +", "+ str(closest_distance))
    ...
    if target:
        results.append({'consumed': True, 'target': target, 'message': Message('A lightning bolt strikes the {0} with a loud thunderclap for {1} damage.'.format(target.name, damage))})
